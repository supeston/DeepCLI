...
export const DownloadSection: React.FC = () => {
  ...
  return (
    <section id="download" className="py-24 relative z-10 bg-slate-50 border-y border-slate-200 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto rounded-[32px] bg-white border border-slate-200 p-8 sm:p-14 shadow-xl relative overflow-hidden">
            <div className="relative z-10">
              <div className="text-center max-w-2xl mx-auto mb-12">
                ...
                <TextScrollReveal
                  text="Available for Windows 10 & 11 (64-bit). The automated installer initializes an isolated environment, browser stealth, and terminal tooling in seconds."
                  className="text-[#5F6368] text-sm sm:text-base font-normal"
                  highlightWords={['Windows', 'automated', 'isolated', 'stealth']}
                />
              </div>
